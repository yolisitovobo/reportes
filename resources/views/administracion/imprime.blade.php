...
<!--
        ...
        <div class="contenido" border=1>
            <table align="center" width='100%'>
                ...
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Usuario del Equipo</label></b></td>
                    <td><label class="align-content-center lbl_txt">&nbsp;{{$us_equ[0]['staff_nombre']}}</label></td>
                </tr>
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Equipo o Problema</label></b></td>
                    <td><label class="align-content-center lbl_txt">&nbsp;{{$equ}}</label></td>
                </tr>
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Descripción del Problema</label></b></td>
                    <td><label class="align-content-center lbl_txt">&nbsp;{{$reporte['des_proble']}}</label></td>
                </tr>
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Fecha del Reporte <br>&nbsp;(dd/mm/aaaa HH:mm)</label></b></td>
                    <td><label class="align-content-center lbl_txt">&nbsp;{{$fecha}}</label></td>
                </tr>
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Técnico Asignado</label></b></td>
                    <td><label class="align-content-center lbl_txt">&nbsp;{{$reporte['tec_asig']}}</label></td>
                </tr>
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Descripción del Trabajo Realizado</label></b></td>
                    <td><label class="align-content-center lbl_txt">&nbsp;{{$reporte['des_tra']}}</label></td>
                </tr>
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Estado del Reporte</label></b></td>
                    <td><label class="align-content-center lbl_txt">&nbsp;{{$reporte['edo_reporte']}}</label></td>
                </tr>
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Marca del Equipo</label></b></td>
                    <td><label class="align-content-center lbl_txt">&nbsp;{{$reporte['marca']}} </label></td>
                </tr>
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Modelo</label></b></td>
                    <td><label class="align-content-center lbl_txt">&nbsp;{{$reporte['modelo']}} </label></td>
                </tr>
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Número de Inventario UNAM</label></b></td>
                    <td><label class="align-content-center lbl_txt">&nbsp;{{$reporte['no_inve']}}</label></td>
                </tr>
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Número de Serie</label></b></td>
                    <td><label class="align-content-center lbl_txt">&nbsp;{{$reporte['no_serie']}}</label></td>
                </tr>
                <tr>
                    <td style="background-color:rgb(207, 226, 255)"><label class="card_computo_1 text-left">&nbsp;<b>Descripción para solicitud Externa</label></b></td>
